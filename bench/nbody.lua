...
for i=1,#bodies do local b = bodies[i]; px = px + b.vx*b.mass; py = py + b.vy*b.mass; pz = pz + b.vz*b.mass end
bodies[1].vx = -px / SOLAR_MASS; bodies[1].vy = -py / SOLAR_MASS; bodies[1].vz = -pz / SOLAR_MASS
local N = #bodies
print(string.format("%0.9f", energy(bodies, N)))
for i=1,500000 do advance(bodies, N, 0.01) end
print(string.format("%0.9f", energy(bodies, N)))
