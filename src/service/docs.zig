...
pub const annotations = [_]Entry{
    ...
    .{ .name = "export", .sig = "@export", .doc = "Shows the field to the host, to be set from outside the script: in an editor, from a saved scene. The host may read more annotations beside it." },
};
