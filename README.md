...
- **`zig build ide`** opens [`examples/ide`](examples/ide), a small IDE on [fluxion-ui](https://github.com/kisstp2006/fluxion-ui): the editor above, the script's members, problems and output, F5 to run, and Ctrl+S while it runs to reload it.
